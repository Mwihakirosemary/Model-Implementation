...
class Account(models.Model):
    ...
    account_type = models.CharField(max_length= 1, choices= ACCOUNTTYPE_CHOICES)
    balance = models.IntegerField()
...
class Transaction(models.Model):
    ...
    transaction_type = models.CharField(max_length= 1, choices= TRASACTION_TYPE_CHOICES)
...
class Card(models.Model):
    ...
    card_issuer = models.CharField(max_length= 1, choices= CARD_ISSUER_CHOICES)
